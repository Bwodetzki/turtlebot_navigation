...
def generate_paths(boundary_vertices, obstacles, sg_params, RRTs_params, plot=False):
    ...
    if path is None:
        # print('bad')
        path = generate_paths(boundary_vertices, obstacles, sg_params, RRTs_params, plot=False)  # or something like that
