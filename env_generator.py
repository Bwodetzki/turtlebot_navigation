...
from env_manager import generate_obstacles, generate_polygon, generate_start_goal, plot_obstacle, save_env, save_path
'''
...
if __name__=='__main__':
    ...
    for i in range(num_envs):
        ...
        for j in range(num_paths):
            path, angle = generate_paths(barrier_vertices, obstacles, plot_path)
